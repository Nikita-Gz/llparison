...
def _load_raw_multiplication_data() -> Dict[str, str]:
  """Returns a dict of {input_code: {'expression': math expression like "90*47=", 'answer': answer value}"""
...
def load_appropriate_dataset_for_task(task_type: TaskType) -> Any:
  ...
  - For basic math: returns a dict of {input_code: {'expression': math expression like "90+47=", 'answer': answer value} 
  """
